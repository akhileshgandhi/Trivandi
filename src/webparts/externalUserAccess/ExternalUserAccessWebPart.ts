...
import * as strings from 'ExternalUserAccessWebPartStrings';
import ExternalUserAccess from './components/ExternalUserAccess';
import { IExternalUserAccessProps } from './components/IExternalUserAccessProps';
...
export default class ExternalUserAccessWebPart extends BaseClientSideWebPart<IExternalUserAccessWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IExternalUserAccessProps> = React.createElement(
      ExternalUserAccess,
      {
